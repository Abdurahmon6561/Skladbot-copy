          ...
          <div>
            ...
            <div class="w-full lg:w-[771px] text-center mt-[40px]">
              <h1 class="font-semibold text-[30px] lg:text-[50px]">
                Единое окно для работы <br />
                по модели FBS
              </h1>
              <p
                class="font-normal text-[16px] lg:text-[21px] mt-[20px] lg:mt-[30px]"
              >
                SkladBot интегрируется по API с Wildberries, Ozon, Яндекс.Маркет
                и Uzum. Автоматически загружает этикетки, передает КИЗы на
                маркетплейсы и формирует лист подбора. После отгрузки списывает
                товар со склада. 
              </p>
            </div>
...
import Possibilities from "../components/fbs/Possibilities.vue";
import Results from "../components/main/Results.vue";
import Support from "../components/main/Support.vue";
import Answers from "../components/fbs/Answers.vue";
