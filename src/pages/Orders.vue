          ...
          <div>
            ...
            <div class="w-full lg:w-[871px] text-center mt-[40px]">
              <h1 class="font-semibold text-[30px] lg:text-[50px]">
                Центр заявок поможет оцифровать все задачи на складе
              </h1>
              <p
                class="font-normal text-[16px] lg:text-[21px] mt-[20px] lg:mt-[30px]"
              >
                В «Центре заявок» директор склада ставит задачи сотрудникам и
                отслеживает процессы в  фулфилменте. Возможности — сканирование
                приходных КИЗов, создание заявок на забор, приёмку, отгрузку,
                заказ товара через байера… 
              </p>
            </div>
...
import Possibilities from "../components/order/PossibilitiesCards.vue";
