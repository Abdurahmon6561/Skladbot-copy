<template>
            ...
            <div>
              ...
              <div class="w-full lg:w-[871px] text-center mt-[40px]">
                <h1 class="font-semibold text-[30px] lg:text-[50px]">
                  SkladBot поможет оцифровать работу сотрудников склада
                </h1>
                <p
                  class="font-normal text-[16px] lg:text-[21px] mt-[20px] lg:mt-[30px]"
                >
                Возможности — создание отделов, просмотр истории действий в системе, ограничение по ролям, уведомления в Телеграм, день рождения сотрудника в календаре.
                </p>
              </div>
  ...
  import Possibilities from "../components/employears/PossibilitiesCards.vue";
