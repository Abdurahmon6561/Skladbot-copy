      ...
      <main>
        ...
        >
          <div>
            ...
            <div class="w-full lg:w-[871px] text-center mt-[40px]">
              <h1 class="font-semibold text-[30px] lg:text-[50px]">
                SkladBot поможет оцифровать и автоматизировать работу с
                клиентами фулфилмента
              </h1>
              <p
                class="font-normal text-[16px] lg:text-[21px] mt-[20px] lg:mt-[30px]"
              >
                Возможности — загрузка товаров по API, личный кабинет клиента,
                авто-выставление счетов за услуги, авто-уведомления о процессе
                работы в Телеграм, массовая рассылка и многое другое.
              </p>
            </div>
