<template>
    <div class="flex justify-center text-center mt-[200px]">
      <div>
        <div>
          ...
          <p class="font-normal lg:text-[21px] text-[16px]">
            Уникальный функционал для владельцев фулфилментов, <br /> который
            сэкономит время и убережёт от штрафов.
          </p>
        </div>
        <div class="mt-[80px] lg:flex">
          <div class="lg:w-[435px] lg:h-[280px] rounded-2xl transform -rotate-[6.06deg] bg-[#E7EEFF] p-6">
          ...
          <!-- Second div -->
          <div class="lg:z-10 lg:w-[548px] lg:h-[231px] rounded-2xl bg-[#3C57FF] p-6 lg:mt-[160px] mt-[70px] lg:ml-[-80px] transform rotate-[4.06deg] lg:rotate-0">
  ...
  <p class="font-normal text-[17px] text-start mt-3 text-white">
    ...
    сотрудникам с доступом к печати.
          ...
          <div class="lg:z-10">
            <div class="lg:z-10 lg:w-[500px] lg:h-[231px] rounded-2xl bg-white p-6 mt-[70px] lg:mt-0 lg:ml-[-80px] transform -rotate-[3.06deg] lg:rotate-0">
              <h2 class="font-semibold text-[25px] text-[#3F4685] text-start">
            ...
            <div class="lg:w-[493px] lg:h-[280px] rounded-2xl transform lg:-rotate-[6.06deg] rotate-[4.06deg] mt-[50px] bg-[#E7EEFF] p-6 lg:mt-[80px] lg:ml-[-80px] ">
              <h2 class="font-semibold text-[25px] text-[#3F4685] text-start">
